...
def isSteadyRising(price,ExData,Capital,Ret_index = 0,n=30):
    ...
    try:
        ...
        if(GoldSpt and AboveRatio > 0.8 and avg_Amount>5 and TurnOver>0.5 and ret<9):
            P1 = True
            return P1
...
if __name__ == '__main__' :
    ...
    for DDate in BTDate:
        ...
        prt_output.to_excel('F:/hyscode/ClosingOrder/output/尾盘追2-1_%s output.xlsx' %DDate)

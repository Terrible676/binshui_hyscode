# -*- coding: utf-8 -*-
"""
Created on Wed Apr 12 15:40:01 2023
...
def SaveExcel(output):
    if(len(output)>0):
        ...
        df.to_excel('F:/hyscode/EarlyChase/output/EarlyChase_%s output.xlsx' %DDate)
...
def main():
    ...
    #td = str(td.date())
    SheetName = 'he_early_chase_'+td + 'test'
